...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        //System.out.println(tempPokemon.attackLevel);
        ...
        while (tempPokemon.defenseLevel > (MAX_HIT_POINTS - tempPokemon.attackLevel)
                || tempPokemon.defenseLevel < 1) {
            System.out.println("Sorry. The defense level must be between 1 and "
                + (MAX_HIT_POINTS - tempPokemon.attackLevel) + ":");
            tempPokemon.defenseLevel = myScan.nextInt();
        }
        //System.out.println(tempPokemon.defenseLevel);
        return tempPokemon;
    }
